...
class CNNModelSaver:
    ...
    def save_model_components(model, tokenizer, optimal_thresholds, categories, base_name="cnn_content_classifier"):
        ...
        print(f"✅ CNN Model components saved:")
...
def main():
    ...
    print("\n✅ All CNN model components saved successfully.")
...
def demo_cnn_loaded_model():
    ...
    try:
        ...
        for cat, score_info in scores.items():
            status = "✓" if score_info['predicted'] else "✗"
...
challenge_sets = {
    ...
    "😠 Adversarial & Loaded (Tests for bias triggers)": [
    ...
    " कॉम्प्लेक्स (Hindi tests - tests robustness to other languages)": [
        "सरकार ने नई शिक्षा नीति की घोषणा की है।", # "The government has announced a new education policy." (Neutral)
        "आप पूरी तरह से मूर्ख हैं और आपकी राय व्यर्थ है।", # "You are a complete fool and your opinion is worthless." (Toxicity)
    ]
}
